...
const config: OrderlyConfig = {
  scaffold: {
    mainNavProps: {
      ...
      // },
      products: [
        { name: "Swap", href: "https://swap.marbleland.io" },
        { name: "Trade", href: "/" },
      ],
      initialProduct: '/'
    },
    footerProps: {
      telegramUrl: "https://t.me/marble_games_news",
      discordUrl: "https://discord.com/invite/marbleland",
      twitterUrl: "https://x.com/marbletoken",
    },
  },
  orderlyAppProvider: {
    appIcons: {
